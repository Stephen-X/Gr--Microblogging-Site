...
from webapps.forms import UserRegisterForm
from site_models.models import UserExtended


# guarantees that writing to user model database is atomic (i.e. either write all or don't write at all)
